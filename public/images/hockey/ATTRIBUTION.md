# Hockey Image Sources

These static assets are used as low-contrast decorative backgrounds in the public marketing and Roadmap pages.

- `empty-rink.jpg` - Photo by Pavel Danilyuk on Pexels, image ID 6539269.
